...
class util {
    ...
    class constants {
        companion object {
            internal var WIFI_STATE_CHANGED = "android.net.wifi.WIFI_STATE_CHANGED"
            internal var STATE_CHANGE = "android.net.wifi.STATE_CHANGE"
            internal var CONNECTIVITY_CHANGE = "android.net.conn.CONNECTIVITY_CHANGE"

            internal var urlService = "https://itunes.apple.com/us/rss/topfreeapplications/limit=20/json"

            internal val DROID_LOGO = "M 149.22,22.00\n" +
